      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full p-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="text-[10px] text-gray-500 space-y-0.5">
            ...
            <p>• <strong>Service Interval:</strong> Service required every X kilometers (e.g., 1000 means every 1000km)</p>
            <p>• <strong>Last Service KM:</strong> Kilometer reading when last service was performed</p>
          </div>
