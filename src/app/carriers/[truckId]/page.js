...
export default function TruckDetailPage() {
  ...
  // Calculate service info - show negative when exceeded
            ...
            <div className="flex items-start gap-3 pr-6">
              ...
              <div className="flex-1">
                <p className={`text-sm font-bold mb-1 ${
                  ...
                  {maintenanceStatus === "overdue" ? "⚠️ Service Overdue!" : "⚠️ Service Due Soon"}
                </p>
                <p className={`text-xs ${
                  maintenanceStatus === "overdue" ? "text-red-700" : "text-yellow-700"
                }`}>
                  {maintenanceStatus === "overdue" 
                    ? `Last service was at ${truck.lastMaintenanceKm?.toLocaleString("en-US") || "0"} km${truck.lastMaintenanceDate ? ` on ${formatDate(truck.lastMaintenanceDate)}` : ""}. Current reading: ${truck.currentMeterReading?.toLocaleString("en-US") || "0"} km. Service is ${Math.abs(kmsRemaining).toLocaleString("en-US")} km overdue!`
                    : `Next service due at ${nextMaintenanceKm.toLocaleString("en-US")} km. Only ${kmsRemaining.toLocaleString("en-US")} km remaining.`
                  }
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-1 space-y-3">
            ...
            <div className="bg-white rounded-lg shadow-sm p-3">
              ...
              <div className="space-y-2">
                {/* Next Service - Highlighted at Top */}
                <div className={`p-3 rounded-lg border-2 ${
                  ...
                  <p className="text-[9px] font-semibold text-gray-700 mb-1 uppercase tracking-wide">Next Service At</p>
                ...
                <div className={`p-2 rounded ${
                  ...
                  <p className="text-[9px] text-gray-600 mb-0.5">Service</p>
            ...
            {/* Service Info */}
            <div className="bg-white rounded-lg shadow-sm p-3">
              <h3 className="text-xs font-semibold text-gray-700 mb-2">Service Info</h3>
